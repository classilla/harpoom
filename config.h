...
#define PACKAGE_NAME "Doom Generic (Harpoom)"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Doom Generic (Harpoom) 0.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "harpoom.tar"
